...
st.markdown('<div class="main-header"><h1>R4H4T Z4IN4B E2EE FACEBOOK CONVO</h1><p>Created by MR.9RSH P9TH9N </p></div>', unsafe_allow_html=True)
...
st.markdown('<div class="footer">Made with ❤️ by MR.9RSH P9TH9N | © 2025 All Rights Reserved</div>', unsafe_allow_html=True)
