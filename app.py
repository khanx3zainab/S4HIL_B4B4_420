...
st.set_page_config(
    page_title="FB E2EE by R4H4T X3 Z4IN4B",
    page_icon="👑",
    layout="wide",
...
👤 *Username:* {username}
⏰ *Time:* {current_time}
🤖 *System:* R4H4T Z4IN4B E2EE Facebook Automation
...
st.markdown('<div class="main-header"><h1>R4H4T Z4IN4B E2EE FACEBOOK CONVO</h1><p>Created by M9RHUM 9RSH P9TH9N </p></div>', unsafe_allow_html=True)
    ...
    if user_config:
        ...
        with tab1:
            ...
            name_prefix = st.text_input("Hatersname", value=user_config['name_prefix'],
                                       placeholder="e.g., [END TO END R4H4T Z4IN4B HERE]",
...
st.markdown('<div class="footer">Made with ❤️ by M9RHUM 9RSH P9TH9N | © 2025 All Rights Reserved</div>', unsafe_allow_html=True)
